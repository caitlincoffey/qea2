function dTdt=timederiv2(t,T,L_absorber, L_wall)
...
L_window = .05; % in meters for window, never varies
...
conduction_insidesurface_outsidesurface = k_transparentwood/(L_window*A_window);
...
% Resitances  
R_window = convection_innerair_insidesurface + conduction_insidesurface_outsidesurface + convection_outsidesurface_outerair;
...
% term
R_walls = convection_indoor_wall + convection_outdoor_wall + conduction_wall; % doesn't change :)
